...
describe('Socket.IO API Route', () => {
  ...
  test('should initialize the Socket.IO server on first request', async () => {
    ...
    // Check that socket was stored on the server
    expect(mockReq.socket.server.io).toBeDefined();
  ...
  test('should handle errors gracefully', async () => {
    // Make the Socket.IO constructor throw an error
    (SocketIOServer as jest.Mock).mockImplementationOnce(() => {
